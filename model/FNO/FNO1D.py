...
def train_fno_1d_wb(model, train_loader, test_loader, device, myloss, batch_size=20, epochs=5000,
                       learning_rate=0.001, weight_decay=1e-4, scheduler_step=100, scheduler_gamma=0.5,
                       plateau_patience=None, plateau_terminate=None, delta=0, print_every=20,
