...
from FNO2D import FNO_space2D_time, dataloader_fno_2d_xi, eval_fno_2d  # noqa: E402
...
def evaluate_one(args, model, data_path, idx, device, myloss):
    ...
    loss_test = eval_fno_2d(model, loader, myloss, args.batch_size, device)
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate FNO2D Phi42 checkpoint on independent MAT test datasets")
