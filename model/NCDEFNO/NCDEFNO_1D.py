...
def train_ncdeinf_1d_wb(model, train_loader, test_loader, device, myloss, batch_size=20, epochs=5000, learning_rate=0.001,
                     scheduler_step=20, scheduler_gamma=0.5, print_every=20, plateau_patience=None, factor=0.1,
    ...
    if plateau_patience is None:
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, patience=plateau_patience, factor=factor, threshold=1e-6,
                                                               min_lr=1e-7)
